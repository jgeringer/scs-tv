  ...
  const options: Options = {
    ...
    renderNode: {
      ...
      [BLOCKS.HEADING_1]: (_: Block, children: React.ReactNode) => (
        <h1 className="text-5xl font-bold text-green-700 tracking-wide mt-6">{children}</h1>
      ),
      [BLOCKS.HEADING_2]: (_: Block, children: React.ReactNode) => (
        <h2 className="text-4xl font-bold text-green-700 tracking-wide mt-5">{children}</h2>
      ),
      [BLOCKS.HEADING_3]: (_: Block, children: React.ReactNode) => (
        <h3 className="text-3xl font-bold text-green-700 tracking-wide mt-4">{children}</h3>
      ),
      [BLOCKS.HEADING_4]: (_: Block, children: React.ReactNode) => (
        <h4 className="text-2xl font-bold text-green-700 tracking-wide mt-3">{children}</h4>
      ),
      [BLOCKS.HEADING_5]: (_: Block, children: React.ReactNode) => (
        <h5 className="text-xl font-bold text-green-700 tracking-wide mt-2">{children}</h5>
      ),
      [BLOCKS.HEADING_6]: (_: Block, children: React.ReactNode) => (
        <h6 className="text-lg font-bold text-green-700 tracking-wide mt-1">{children}</h6>
      ),
      ...
      [BLOCKS.QUOTE]: (_: Block, children: React.ReactNode) => (
        <blockquote className="border-l-4 border-gray-300 pl-4 italic mt-2">{children}</blockquote>
      ),
